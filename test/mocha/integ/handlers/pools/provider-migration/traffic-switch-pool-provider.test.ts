...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from '@0xelod/smart-order-router'
...
import { metric } from '@0xelod/smart-order-router/build/main/util/metric'
import { setupTables } from '../../../../dbSetup'
import {
  DAI_MAINNET as DAI,
  USDC_MAINNET as USDC,
} from '@0xelod/smart-order-router/build/main/providers/token-provider'
